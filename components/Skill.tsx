...
const Skill = ({ directionLeft, skill }: Props) => {
  return (
    <div className='group relative flex cursor-pointer hover:scale-105 transition duration-300 ease-in-out'>
        ...
        className='rounded-full border border-gray-500 object-fill w-24 h-24 md:w-28 md:h-28 xl:w-32 xl:h-32 filter group-hover:brightness-[35%] group-hover:blur-[1px] group-hover:border-orange-500 group-hover:border-opacity-50 group-hover:scale-110 transition duration-300 ease-in-out'
        />
